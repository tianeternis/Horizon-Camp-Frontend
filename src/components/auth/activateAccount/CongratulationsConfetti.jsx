  ...
  return (
    <div className="flex items-center justify-center pt-6">
      <div className="space-y-2">
        ...
        />
        <div className="text-center text-sm font-bold text-black md:text-base">
          🎉 {t("auth.activate-account.congratulations")} 🎉
        </div>
        <div className="flex justify-center pt-4">
          <Link
            to={PATHS.login()}
            className="rounded-md bg-main px-4 py-2 text-13px font-medium text-white hover:bg-primary md:text-sm"
          >
