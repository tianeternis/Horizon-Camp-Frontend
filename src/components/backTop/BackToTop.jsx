...
const BackToTop = ({}) => {
  ...
  return (
    visible && (
      <div
        onClick={scrollToTop}
        className="fixed bottom-20 right-6 z-50 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-main text-white shadow-lg sm:h-12 sm:w-12"
      >
