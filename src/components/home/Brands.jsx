...
const Brands = ({}) => {
  ...
  return (
    <div className="home-brands w-full bg-[#fef7ef] py-16">
      <div className="group relative">
        <div className="mx-auto max-w-screen-xl cursor-pointer px-3">
          <button
            className="invisible absolute left-20 top-1/2 z-10 -translate-x-6 -translate-y-1/2 transform duration-150 hover:text-secondary group-hover:visible group-hover:translate-x-0"
          ...
          <button
            className="invisible absolute right-20 top-1/2 z-10 -translate-y-1/2 translate-x-6 transform duration-150 hover:text-secondary group-hover:visible group-hover:translate-x-0"
